...
const sites = [
  ...
  { id: "community", url: "https://community.linkareer.com/", name: "링커리어 커뮤니티" },
  { id: "cbt", url: "sc-domain:cbt-community.linkareer.com", name: "링커리어 CBT 커뮤니티" }
];
          ...
          return {
            ...
            metrics: {
              ...
              impressions: {
                ...
                change: calculateChange(current.impressions || 0, prev.impressions || 0)
              },
              ctr: {
                value: current.ctr || 0,
